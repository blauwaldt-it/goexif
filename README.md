...
[![GoDoc](https://godoc.org/github.com/blauwaldt-it/goexif?status.svg)](https://godoc.org/github.com/blauwaldt-it/goexif)
...
```
go get github.com/blauwaldt-it/goexif/exif
```

Or if you just want the tiff package:

```
go get github.com/blauwaldt-it/goexif/tiff
```
